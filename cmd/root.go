...
import (
	...
	dbInfra "github.com/brenovergilio/ports-and-adapters-go/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.ports-and-adapters-go.yaml)")
